...
urlpatterns = [
    ...
    path('admin-panel/amenities/', views.admin_amenities, name='admin_amenities'),
    path('admin-panel/amenities/delete/<int:pk>/', views.admin_delete_amenity, name='admin_delete_amenity'),
