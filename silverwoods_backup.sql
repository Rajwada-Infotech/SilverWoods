-- MySQL dump 10.13  Distrib 8.0, for Win64
--
-- Host: localhost    Database: silverwoods
-- ------------------------------------------------------
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `silverwoods` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
...
--
-- Table structure for table `core_projectinfo`
--
...
--
-- Table structure for table `core_flattype`
--
...
--
-- Table structure for table `core_amenity`
--
...
--
-- Table structure for table `core_popupad`
--
...
--
-- Table structure for table `core_sitevisitor`
--
...
--
-- Table structure for table `core_buildingflat`
--
...
--
-- Table structure for table `core_villaplot`
--
...
--
-- Table structure for table `core_brochureimage`
--
...
--
-- Table structure for table `core_chatbotqa`
--
...
-- Dump completed
-- No data rows: this is a blank/empty database backup (schema only)
